      ...
      <table className="min-w-full">
        <thead>
          <tr className="text-left">
            <th className="py-3 px-4 text-gray-800 font-medium text-[13px] whitespace-nowrap">
              Name
            </th>
            <th className="py-3 px-4 text-gray-800 font-medium text-[13px] whitespace-nowrap">
              Status
        ...
        <tbody>
          {tableData.map((task) => (
            <tr className="border-t border-gray-200" key={task._id}>
              <td className="my-3 mx-4 text-gray-700 text-[13px] line-clamp-1 whitespace-nowrap">
                {task.title}
              </td>
              ...
              <td className="p-4 text-gray-700 text-[13px] text-nowrap whitespace-nowrap">
                {task.createdAt
